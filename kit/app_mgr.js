...
(function() {
  var Q, app_path, coffee_bin, conf_path, env_mode, example_path, forever_bin, os, _;
  ...
  switch (process.argv[2]) {
    ...
    case 'debug':
      global.NB = {};
      require('../var/config');
      os.spawn(coffee_bin, ['--nodejs', '--debug-brk=' + NB.conf.debug_port, app_path], env_mode('development'));
      break;
    case 'start':
      os.spawn(forever_bin, ['start', '--minUptime', '5000', '--spinSleepTime', '5000', '-a', '-o', 'var/log/std.log', '-e', 'var/log/err.log', '-c', coffee_bin, app_path], env_mode('production'));
      break;
    case 'stop':
